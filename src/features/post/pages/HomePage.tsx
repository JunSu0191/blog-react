...
import { Compass, LibraryBig, Sparkles, Tags, TrendingUp } from "lucide-react";
import { Badge, Card, CardContent, CardHeader } from "@/components/ui";
import { resolveDisplayName } from "@/shared/lib/displayName";
import { ActionTextLink, Button, TagChip } from "@/shared/ui";
              ...
              {spotlightAuthors.length > 0 ? (
                spotlightAuthors.map((author) => (
                  <Link
                    ...
                    className="block rounded-2xl border border-slate-200 bg-white px-4 py-3 transition hover:border-blue-200 hover:bg-blue-50/70 dark:border-slate-700 dark:bg-slate-900 dark:hover:border-blue-900/60 dark:hover:bg-blue-950/20"
                  >
